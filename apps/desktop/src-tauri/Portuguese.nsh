...
LangString createDesktop ${LANG_PORTUGUESE} "Criar atalho na Área de Trabalho"
...
LangString installingWebview2 ${LANG_PORTUGUESE} "Instalando WebView2..."
...
LangString webview2Downloading ${LANG_PORTUGUESE} "Transferindo o Bootstrapper do WebView2..."
...
LangString deleteAppData ${LANG_PORTUGUESE} "Excluir banco de dados (Atenção: Apaga todos os clientes, OS e cadastros)"
