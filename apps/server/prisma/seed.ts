...
import { VisitStatus, PeriodoVisita, OrderStatus } from '@sistema-os/shared';
...
async function seed() {
  ...
  const os1 = await prisma.serviceOrder.create({
    data: {
      ...
      status: OrderStatus.EM_ATENDIMENTO,
      totalAmount: 380.0,
    },
  });
